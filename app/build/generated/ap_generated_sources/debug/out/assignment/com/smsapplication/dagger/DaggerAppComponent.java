...
public final class DaggerAppComponent implements AppComponent {
  ...
  private Provider<SmsPresenter> provideWeatherPresenterProvider;
  ...
  private void initialize(final AppModule appModuleParam,
    ...
    this.provideWeatherPresenterProvider = DoubleCheck.provider(PresenterModule_ProvideWeatherPresenterFactory.create(presenterModuleParam, provideSmsAPIProvider));
  }
  ...
  private SmsActivity injectSmsActivity(SmsActivity instance) {
    SmsActivity_MembersInjector.injectSmsPresenter(instance, provideWeatherPresenterProvider.get());
    return instance;
  }
